...
assert(catalog.current?.id === "next", "Version catalog must expose current main as next.");
assert(
...
for (const release of catalog.releases) {
  assert(release.id === `v${release.version}`, `Invalid release id for ${release.version}.`);
