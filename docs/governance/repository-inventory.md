...
| Public exports | 79 root names. `ActionState`, `ActionStateOptions`, `ActiveItemChangeDetail`, `BehaviorChangeReason`, `behaviorChangeReasons`, `BehaviorController`, `BehaviorEvent`, `BehaviorEventChannel`, `BehaviorEventListener`, `BehaviorListener`, `BehaviorSnapshotChannel`, `BehaviorSnapshotUnsubscribe`, `BehaviorUnsubscribe`, `ChoiceActiveChangeDetail`, `ChoiceChangeDetail`, `ChoiceCommand`, `ChoiceController`, `ChoiceControllerEvent`, `ChoiceControllerOptions`, `ChoiceItem`, `ChoiceKey`, `ChoiceSnapshot`, `CollectionChangeDetail`, `CollectionCommand`, `CollectionController`, `CollectionControllerEvent`, `CollectionControllerOptions`, `CollectionItem`, `CollectionKey`, `CollectionMoveIntent`, `CollectionMutation`, `CollectionSnapshot`, `ControllableStateChangeDetail`, `ControllableStateChangeEvent`, `ControllableStateCommand`, `ControllableStateController`, `ControllableStateOptions`, `ControllableStateSnapshot`, `createBehaviorEvent`, `createBehaviorEventChannel`, `createBehaviorSnapshotChannel`, `createChoiceController`, `createCollectionController`, `createControllableState`, `createNumericValueController`, `createSelectionController`, `createTabsController`, `createToggleController`, `createToggleGroupController`, `normalizeNumericValue`, `NumericRange`, `NumericValueController`, `NumericValueControllerOptions`, `resolveActionState`, `resolveToggleInputState`, `SelectionChangeDetail`, `SelectionChangeEvent`, `SelectionCommand`, `SelectionController`, `SelectionControllerOptions`, `SelectionKey`, `SelectionMode`, `SelectionOperation`, `SelectionSnapshot`, `StateUpdater`, `TabsCommand`, `TabsController`, `TabsControllerOptions`, `TabsItem`, `TabsSnapshot`, `ToggleChangeDetail`, `ToggleController`, `ToggleControllerOptions`, `ToggleGroupController`, `ToggleGroupControllerOptions`, `ToggleGroupValue`, `ToggleInputState`, `ToggleInputStateOptions`, `vyrnForgeUiBehaviorsVersion` |
...
| Test files | 67 |
| Pure/unit | 46 focused pure/unit test files, primarily covering grid core, state, adapters, themes, and governance scripts. |
...
| Package-root export names | 439 |
| Public components inventoried | 75 |
| Repository test files | 67 |
