...
| Documentation | 100 active Markdown files; 23 archived Markdown files |
...
| Field | Inventory |
| --- | --- |
| Purpose | Shared VyrnForge design foundation for semantic tokens, themes, density, typography, motion, layers, utilities, and theme helpers. |
| Main source directories | `src/styles`, `src/theme` |
| Public exports | 25 root names. `createVyrnForgeTheme`, `getVyrnForgeThemePreset`, `mergeVyrnForgeTheme`, `normalizeVyrnForgeDensity`, `toVyrnForgeThemeStyle`, `vyrnForgeCanonicalDensities`, `VyrnForgeCanonicalDensity`, `VyrnForgeCssVar`, `vyrnForgeDarkTheme`, `VyrnForgeDensity`, `vyrnForgeDensityAliases`, `vyrnForgeEnterpriseTheme`, `vyrnForgeLayerOrder`, `VyrnForgeLayerToken`, `VyrnForgeLegacyDensity`, `vyrnForgeLightTheme`, `VyrnForgeSemanticToken`, `VyrnForgeSemanticTokenGroup`, `vyrnForgeSemanticTokenGroups`, `VyrnForgeTheme`, `vyrnForgeThemeColorTokens`, `VyrnForgeThemeName`, `VyrnForgeThemeVars`, `vyrnForgeUiCoreVersion`, `VyrnForgeVariant` |
...
| Field | Inventory |
| --- | --- |
| Purpose | Framework-neutral state, collection, selection, action, toggle, choice, numeric, Tabs, subscription, and reasoned event contracts for public non-grid components. |
| Main source directories | None |
| Public exports | 115 root names. `ActionState`, `ActionStateOptions`, `ActiveItemChangeDetail`, `AutocompleteCommand`, `AutocompleteController`, `AutocompleteControllerEvent`, `AutocompleteControllerOptions`, `AutocompleteFilterFunction`, `AutocompleteItem`, `AutocompleteSnapshot`, `BehaviorChangeReason`, `behaviorChangeReasons`, `BehaviorController`, `BehaviorEvent`, `BehaviorEventChannel`, `BehaviorEventListener`, `BehaviorListener`, `BehaviorSnapshotChannel`, `BehaviorSnapshotUnsubscribe`, `BehaviorUnsubscribe`, `ChoiceActiveChangeDetail`, `ChoiceChangeDetail`, `ChoiceCommand`, `ChoiceController`, `ChoiceControllerEvent`, `ChoiceControllerOptions`, `ChoiceItem`, `ChoiceKey`, `ChoiceSnapshot`, `CollectionChangeDetail`, `CollectionCommand`, `CollectionController`, `CollectionControllerEvent`, `CollectionControllerOptions`, `CollectionItem`, `CollectionKey`, `CollectionMoveIntent`, `CollectionMutation`, `CollectionSnapshot`, `ControllableStateChangeDetail`, `ControllableStateChangeEvent`, `ControllableStateCommand`, `ControllableStateController`, `ControllableStateOptions`, `ControllableStateSnapshot`, `createAutocompleteController`, `createBehaviorEvent`, `createBehaviorEventChannel`, `createBehaviorSnapshotChannel`, `createChoiceController`, `createCollectionController`, `createControllableState`, `createMultiSelectController`, `createNumericValueController`, `createSelectionController`, `createTabsController`, `createToggleController`, `createToggleGroupController`, `createTransferListController`, `defaultAutocompleteBehaviorFilter`, `defaultMultiSelectBehaviorFilter`, `defaultTransferListBehaviorFilter`, `enabledTransferListValues`, `getFirstEnabledAutocompleteIndex`, `getLastEnabledAutocompleteIndex`, `getNextEnabledAutocompleteIndex`, `MultiSelectCommand`, `MultiSelectController`, `MultiSelectControllerEvent`, `MultiSelectControllerOptions`, `MultiSelectFilterFunction`, `MultiSelectItem`, `MultiSelectSnapshot`, `normalizeNumericValue`, `normalizeTransferListValues`, `NumericRange`, `NumericValueController`, `NumericValueControllerOptions`, `partitionTransferListItems`, `resolveActionState`, `resolveToggleInputState`, `selectedEnabledTransferListValues`, `SelectionChangeDetail`, `SelectionChangeEvent`, `SelectionCommand`, `SelectionController`, `SelectionControllerOptions`, `SelectionKey`, `SelectionMode`, `SelectionOperation`, `SelectionSnapshot`, `StateUpdater`, `TabsCommand`, `TabsController`, `TabsControllerOptions`, `TabsItem`, `TabsSnapshot`, `ToggleChangeDetail`, `ToggleController`, `ToggleControllerOptions`, `ToggleGroupController`, `ToggleGroupControllerOptions`, `ToggleGroupValue`, `ToggleInputState`, `ToggleInputStateOptions`, `TransferListCommand`, `TransferListController`, `TransferListControllerEvent`, `TransferListControllerOptions`, `TransferListFilterFunction`, `TransferListItem`, `TransferListPanel`, `TransferListSnapshot`, `uniqueTransferListItems`, `vyrnForgeUiBehaviorsVersion` |
...
| Suggested accountable owner | Multi-Framework Team |
...
| CSS entry points | `./index.css`, `./style.css`, `./styles/index.css` |
| Dependencies | `@vyrnforge/ui-behaviors@0.1.0-alpha.1`, `@vyrnforge/ui-core@0.1.0-alpha.1` |
...
| AppShell | @vyrnforge/ui-components | packages/ui-components/src/components/AppShell/AppShell.tsx | Yes | docs/api/ui-components-api.md, docs/architecture/07-overlay-and-focus.md | /components/layout/app-shell | packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| Autocomplete | @vyrnforge/ui-components | packages/ui-components/src/components/Autocomplete/Autocomplete.tsx | Yes | docs/api/ui-components-api.md, docs/architecture/07-overlay-and-focus.md | /components/forms/autocomplete | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/dom-interactions.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
...
| Checkbox | @vyrnforge/ui-components | packages/ui-components/src/components/Checkbox/Checkbox.tsx | Yes | docs/api/ui-behaviors-api.md, docs/api/ui-components-api.md | /components/forms/checkbox | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
...
| Dropdown | @vyrnforge/ui-components | packages/ui-components/src/components/Dropdown/Dropdown.tsx | Yes | docs/api/css-token-reference.md, docs/api/ui-components-api.md | /components/overlays/dropdown | No focused test found | Requires verification | experimental | No focused test evidence; No browser evidence; No accessibility-test evidence | Component Team |
...
| Inline | @vyrnforge/ui-components | packages/ui-components/src/components/Inline/Inline.tsx | Yes | docs/api/ui-components-api.md, docs/governance/repository-inventory.md | No dedicated route found | No focused test found | Requires verification | experimental | No dedicated playground route; No focused test evidence; No browser evidence; No accessibility-test evidence | Component Team |
...
| Radio | @vyrnforge/ui-components | packages/ui-components/src/components/Radio/Radio.tsx | Yes | docs/api/ui-components-api.md, docs/governance/repository-inventory.md | /components/forms/radio | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| RadioGroup | @vyrnforge/ui-components | packages/ui-components/src/components/RadioGroup/RadioGroup.tsx | Yes | docs/api/ui-behaviors-api.md, docs/api/ui-components-api.md | /components/forms/radio-group | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| Rating | @vyrnforge/ui-components | packages/ui-components/src/components/Rating/Rating.tsx | Yes | docs/api/ui-behaviors-api.md, docs/api/ui-components-api.md | /components/forms/rating | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
...
| SegmentedControl | @vyrnforge/ui-components | packages/ui-components/src/components/SegmentedControl/SegmentedControl.tsx | Yes | docs/api/ui-behaviors-api.md, docs/api/ui-components-api.md | /components/actions/segmented-control | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| Select | @vyrnforge/ui-components | packages/ui-components/src/components/Select/Select.tsx | Yes | docs/api/ui-components-api.md, docs/components/forms/autocomplete.md | /components/forms/select | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/dom-interactions.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| SideNav | @vyrnforge/ui-components | packages/ui-components/src/components/SideNav/SideNav.tsx | Yes | docs/api/ui-components-api.md, docs/governance/repository-inventory.md | No dedicated route found | packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup | experimental | No dedicated playground route; No browser evidence; No accessibility-test evidence | Component Team |
...
| Slider | @vyrnforge/ui-components | packages/ui-components/src/components/Slider/Slider.tsx | Yes | docs/api/ui-behaviors-api.md, docs/api/ui-components-api.md | /components/forms/slider | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
...
| Switch | @vyrnforge/ui-components | packages/ui-components/src/components/Switch/Switch.tsx | Yes | docs/api/ui-behaviors-api.md, docs/api/ui-components-api.md | /components/forms/switch | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| Tabs | @vyrnforge/ui-components | packages/ui-components/src/components/Tabs/Tabs.tsx | Yes | docs/api/ui-components-api.md, docs/benchmark/02-component-coverage-comparison.md | /components/navigation/tabs | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/dom-interactions.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| Text | @vyrnforge/ui-components | packages/ui-components/src/components/Typography/Text.tsx | Yes | docs/api/css-token-reference.md, docs/api/ui-components-api.md | No dedicated route found | packages/ui-components/src/components/__tests__/accessibility.test.tsx, packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/dom-interactions.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction, accessibility | experimental | No dedicated playground route; No browser evidence | Component Team |
...
| Toast | @vyrnforge/ui-components | packages/ui-components/src/components/Toast/Toast.tsx | Yes | docs/api/css-token-reference.md, docs/architecture/07-overlay-and-focus.md | /components/feedback/toast | packages/ui-components/src/components/__tests__/dom-interactions.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
...
| ToggleButton | @vyrnforge/ui-components | packages/ui-components/src/components/ToggleButton/ToggleButton.tsx | Yes | docs/api/ui-components-api.md, docs/governance/repository-inventory.md | /components/actions/toggle-button | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
| ToggleButtonGroup | @vyrnforge/ui-components | packages/ui-components/src/components/ToggleButtonGroup/ToggleButtonGroup.tsx | Yes | docs/api/ui-components-api.md, docs/governance/repository-inventory.md | /components/actions/toggle-button-group | packages/ui-components/src/components/__tests__/behavior-parity.test.tsx, packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup, DOM interaction | experimental | No browser evidence; No accessibility-test evidence | Component Team |
...
| Documentation sources | 100 active Markdown files across governance, architecture, API, packages, quality, release, engineering, roadmap, legal, and benchmarks. |
...
| Test files | 70 |
| Pure/unit | 49 focused pure/unit test files, primarily covering grid core, state, adapters, themes, and governance scripts. |
| Static markup | 2 test files use server-side static markup rendering. |
| DOM interaction | 4 detected test files with DOM interaction helpers. |
