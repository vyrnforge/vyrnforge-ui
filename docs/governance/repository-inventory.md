...
| Select | @vyrnforge/ui-components | packages/ui-components/src/components/Select/Select.tsx | Yes | docs/api/ui-components-api.md, docs/components/forms/autocomplete.md | /components/forms/select | packages/ui-components/src/components/__tests__/primitives.test.tsx | pure/unit, static markup | experimental | No browser evidence; No accessibility-test evidence | Component Team |
