...
| `api/ui-behaviors-api.md`                     | Public framework-neutral state, navigation, overlay, selection, and event API.   |
...
| `quality/s4-multi-framework-architecture.md`   | MF-4001Ã¢â‚¬â€œMF-4008 architecture evidence and explicit GMF1 support-claim boundary.                              |
...
| `testing/behavior-foundation-contracts.md`  | MF-5001Ã¢â‚¬â€œMF-5014 package and repository evidence.                                   |
| `testing/behavior-react-parity.md`          | MF-5005Ã¢â‚¬â€œMF-5014 React adapter parity evidence.                                     |
