...
| Multi-framework support | [ADR-004: Multi-Framework Web Support](architecture/adr-004-multi-framework-web-support.md) |
...
[`metadata/components.json`](metadata/components.json); current limitations are
owned by [Known Limitations](quality/03-known-limitations.md).
...
| Area | Purpose |
| --- | --- |
| [quality/](quality/) | Current quality gates, limitations, architecture evidence, accessibility evidence, and justified retained records. |
| [testing/](testing/) | Browser, visual, compatibility, consumer, and framework verification contracts. |
| [metadata/](metadata/) | Structured contracts and current evidence state. |
