...
| Application runtime separation      | Business data, auth, routing, permissions, persistence and workflows remain application-owned.                                                                    | Strong                                           | Preserve; refine wording so workflow _UI_ may be in scope while workflow execution stays outside.                                                   |
