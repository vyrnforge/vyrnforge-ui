...
> Replacement: ../../architecture/04-clean-code-boundaries.md and ../../packages/ui-data-grid.md
...
Existing public exports from `core/createGridState`, `core/columnManagement`, `core/gridPersistence`, and `core/exportRequestBuilder` are preserved. New canonical modules live under `state/`, `adapters/`, and grouped core folders:
