...
| Evidence          | Static adoption verification and computed browser evidence cover components and grid across light/dark themes.                                                    | VF-3011 adds the broader visual regression matrix.                                                       |
