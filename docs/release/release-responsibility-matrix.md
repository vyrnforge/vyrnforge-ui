...
| Package payload and size verification           | Planned package/public payload changes               | Release engineering      | `_packages.yml`                                                              | `contents: read`                    | BT-8003 tarball evidence plus BT-8004 package/CSS size report                                            |
