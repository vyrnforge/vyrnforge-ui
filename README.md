...
- Shared component state and behavior move into `@vyrnforge/ui-behaviors`; MF-5001–MF-5012 foundations and React migrations through Menu, SideNav, and the shared overlay lifecycle boundary are implemented.
