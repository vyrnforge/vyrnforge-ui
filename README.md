...
- Angular 22 is a packed, Chromium-verified consumer of the native element surface. CF-7004 adds a thin reactive/template-driven Forms reference adapter without adding Angular to VyrnForge packages; Vue remains the next verified-consumer runtime task.
