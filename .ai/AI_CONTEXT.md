...
| `@vyrnforge/ui-elements`   | native registration, lifecycle, observed attributes, property reflection, update scheduling, events, Light DOM, and forms | EL-6001/EL-6002 complete; S6 active |
