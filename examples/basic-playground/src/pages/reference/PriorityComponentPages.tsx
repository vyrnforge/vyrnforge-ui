...
const componentImports = 'import { Button } from "@dravyn/ui-components";';
...
</Inline>`, scope, 'import { Button, Inline } from "@dravyn/ui-components";') },
...
export function IconButtonPage() {
  ...
  return <ComponentDemoPage
    ...
    importCode={'import { Icon, IconButton } from "@dravyn/ui-components";'}
    packageName="@dravyn/ui-components"
    ...
    sections={[
      { id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("icon-button-basic-live", "Accessible utility action", '<IconButton aria-label="Refresh orders" tooltip="Refresh orders"><Icon name="Refresh" /></IconButton>', scope, 'import { Icon, IconButton } from "@dravyn/ui-components";') },
...
</Inline>`, scope, 'import { Icon, IconButton, Inline } from "@dravyn/ui-components";') },
...
export function ButtonGroupPage() {
  ...
  return <ComponentDemoPage
    ...
    importCode={'import { Button, ButtonGroup } from "@dravyn/ui-components";'}
    packageName="@dravyn/ui-components"
  ...
  <Button>Month</Button>
</ButtonGroup>`, scope, 'import { Button, ButtonGroup } from "@dravyn/ui-components";') },
...
export function ToolbarButtonPage() {
  ...
  return <ComponentDemoPage
    ...
    importCode={'import { Icon, ToolbarButton } from "@dravyn/ui-components";'}
    packageName="@dravyn/ui-components"
    ...
    sections={[
      { id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("toolbar-button-basic-live", "Labelled toolbar action", '<ToolbarButton icon={<Icon name="Refresh" />} label="Refresh" />', scope, 'import { Icon, ToolbarButton } from "@dravyn/ui-components";') },
...
export function TextInputPage() {
  ...
  return <ComponentDemoPage accessibility={["Provide a visible Field label or aria-label.", "Pair invalid state with clear validation text."]} avoidWhen={["The value is a search query; use SearchInput.", "The value spans multiple lines; use Textarea."]} description="A native text input with Dravyn sizing and validation styling." importCode={'import { Field, TextInput } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components" props={[{ name: "invalid", type: "boolean", defaultValue: "false", description: "Invalid visual state." }, { name: "size", type: '"sm" | "md" | "lg"', defaultValue: '"md"', description: "Input size." }, { name: "value", type: "string", description: "Controlled native value." }, { name: "defaultValue", type: "string", description: "Initial uncontrolled value." }]} relatedComponents={[]} sections={[{ id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("text-input-basic-live", "Workspace name", '<Field htmlFor="workspace-name" label="Workspace name"><TextInput id="workspace-name" defaultValue="Operations" /></Field>', scope, 'import { Field, TextInput } from "@dravyn/ui-components";') }, { id: "states", label: "States", title: "States", children: live("text-input-states-live", "Invalid and disabled", `<Stack gap="sm">
...
export function SelectPage() {
  ...
  return <ComponentDemoPage accessibility={["Associate the select with a visible label or aria-label.", "Keep option labels concise."]} avoidWhen={["The option list is large or asynchronous.", "The user chooses multiple values; use MultiSelect."]} description="A native select with shared Dravyn styling for compact option sets." importCode={'import { Select } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components" props={[{ name: "options", type: "SelectOption[]", description: "Option labels, values, and disabled state." }, { name: "invalid", type: "boolean", defaultValue: "false", description: "Invalid visual state." }, { name: "value", type: "string", description: "Controlled selected value." }]} relatedComponents={[]} sections={[{ id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("select-basic-live", "Region selection", '<Select aria-label="Region" defaultValue="apac" options={[{ label: "APAC", value: "apac" }, { label: "EMEA", value: "emea" }, { label: "AMER", value: "amer" }]} />', scope, 'import { Select } from "@dravyn/ui-components";') }, { id: "states", label: "States", title: "States", children: live("select-states-live", "Invalid and unavailable options", `<Stack gap="sm">
...
</Stack>`, scope, 'import { Select, Stack } from "@dravyn/ui-components";') }]} status="experimental" title="Select" useWhen={["Choosing one option from a short stable list.", "Native select behavior fits the workflow."]} />;
}

export function CheckboxPage() {
  const scope = createLiveScope("Checkbox", "Stack");
  return <ComponentDemoPage accessibility={["The label must explain the checked state.", "Use error copy near invalid choices."]} avoidWhen={["Choosing one exclusive option; use RadioGroup.", "Toggling an immediate setting; use Switch."]} description="A native checkbox for acknowledgements, permissions, and independent choices." importCode={'import { Checkbox } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components" props={[{ name: "label", type: "ReactNode", description: "Visible checkbox label." }, { name: "invalid", type: "boolean", defaultValue: "false", description: "Invalid visual state." }, { name: "checked", type: "boolean", description: "Controlled checked state." }, { name: "defaultChecked", type: "boolean", description: "Initial uncontrolled state." }]} relatedComponents={[]} sections={[{ id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("checkbox-basic-live", "Acknowledgement", '<Checkbox defaultChecked label="I agree to the workspace policy" />', scope, 'import { Checkbox } from "@dravyn/ui-components";') }, { id: "states", label: "States", title: "States", children: live("checkbox-states-live", "Controlled, disabled, and invalid", `function Example() {
...
render(<Example />);`, scope, 'import { Checkbox, Stack } from "@dravyn/ui-components";') }]} status="experimental" title="Checkbox" useWhen={["Acknowledging a statement.", "Selecting several independent options."]} />;
}

export function BadgePage() {
  const scope = createLiveScope("Badge", "Inline");
  return <ComponentDemoPage accessibility={["Use a meaningful label; color alone cannot communicate important state."]} avoidWhen={["Displaying a primary action.", "Showing a sentence or long content."]} description="A compact label for status, metadata, and categorization." importCode={'import { Badge } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components" props={[{ name: "variant", type: '"neutral" | "success" | "warning" | "danger" | "info"', defaultValue: '"neutral"', description: "Semantic color." }, { name: "tone", type: '"subtle" | "solid"', defaultValue: '"subtle"', description: "Surface emphasis." }, { name: "size", type: '"sm" | "md"', defaultValue: '"md"', description: "Badge size." }]} relatedComponents={[]} sections={[{ id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("badge-basic-live", "Status label", '<Badge variant="success">Ready</Badge>', scope, 'import { Badge } from "@dravyn/ui-components";') }, { id: "variants", label: "Variants", title: "Variants", children: live("badge-variants-live", "Semantic variants", `<Inline gap="sm" wrap>
  <Badge>Neutral</Badge>
...
</AppShell>`, scope, 'import { AppShell, Panel, SideNav, Text, TopNav } from "@dravyn/ui-components";') }]} status="experimental" title="AppShell" useWhen={["Building an admin portal or workspace with persistent navigation.", "The app needs predictable content scrolling."]} />;
}

export function TabsPage() {
  const scope = createLiveScope("Tabs", "Text");
  return <ComponentDemoPage accessibility={["Tabs support arrow, Home, and End keyboard navigation.", "Each tab label should identify its panel clearly."]} avoidWhen={["Switching simple modes without panels; use SegmentedControl.", "Navigating to unrelated routes; use SideNav or TopNav."]} description="Controlled or uncontrolled navigation between related content panels." importCode={'import { Tabs } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components" props={[{ name: "items", type: "TabItem[]", required: true, description: "Tab labels, content, and disabled state." }, { name: "value", type: "string", description: "Controlled selected tab." }, { name: "defaultValue", type: "string", description: "Initial uncontrolled tab." }, { name: "onValueChange", type: "(value: string) => void", description: "Selection callback." }, { name: "variant", type: '"line" | "contained" | "pills"', defaultValue: '"line"', description: "Visual treatment." }]} relatedComponents={[{ id: "segmented-control", name: "SegmentedControl", description: "Small mutually exclusive modes." }]} sections={[{ id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("tabs-basic-live", "Related content panels", `function Example() {
