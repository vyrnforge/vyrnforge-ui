...
export function RatingPage() {
  ...
  return <ComponentDemoPage
    ...
    sections={[
      { id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("rating-basic-live", "Service rating", '<Rating defaultValue={3} label="Service rating" />', scope, 'import { Rating } from "@vyrnforge/ui-components";') },
...
render(<Example />);`, scope, 'import { Rating } from "@vyrnforge/ui-components";') },
...
export function SliderPage() {
  ...
  return <ComponentDemoPage
    ...
    sections={[
      { id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("slider-basic-live", "Threshold", '<Slider ariaLabel="Approval threshold" defaultValue={65} label="Approval threshold" showValue />', scope, 'import { Slider } from "@vyrnforge/ui-components";') },
...
render(<Example />);`, scope, 'import { Slider } from "@vyrnforge/ui-components";') },
...
export function ToggleButtonPage() {
  ...
  return <ComponentDemoPage
    ...
    sections={[
      { id: "basic-usage", label: "Basic usage", title: "Basic usage", children: live("toggle-button-basic-live", "Pin tool", '<ToggleButton defaultPressed>Pin column</ToggleButton>', scope, 'import { ToggleButton } from "@vyrnforge/ui-components";') },
...
render(<Example />);`, scope, 'import { ToggleButton } from "@vyrnforge/ui-components";') },
...
export function ToggleButtonGroupPage() {
  ...
  return <ComponentDemoPage
    ...
    importCode={'import { ToggleButton, ToggleButtonGroup } from "@vyrnforge/ui-components";'}
    packageName="@vyrnforge/ui-components"
...
</ToggleButtonGroup>`, scope, 'import { ToggleButton, ToggleButtonGroup } from "@vyrnforge/ui-components";') },
...
render(<Example />);`, scope, 'import { ToggleButton, ToggleButtonGroup } from "@vyrnforge/ui-components";') },
