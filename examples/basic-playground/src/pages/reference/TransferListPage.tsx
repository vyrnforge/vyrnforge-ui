...
export function TransferListPage() {
  ...
  const richScope = createLiveScope(
    "TransferList",
    "Badge",
    "Button",
    "Caption",
  ...
  return (
    <ComponentDemoPage
      ...
      props={[
        {
          name: "options",
          type: "readonly TransferListOptionData[]",
          required: true,
          description:
            "Known option contract with value, plain-text label, optional description, disabled state, and keywords.",
        },
        {
          ...
          defaultValue: "[]",
          description:
            "Controlled or initial assigned target values. Unknown and duplicate values are normalized visually.",
        },
        {
          name: "onValueChange",
          type: "(value, options) => void",
          description:
            "Called with ordered assigned values and their option objects.",
        },
        {
          name: "searchable",
          type: "boolean",
          defaultValue: "false",
          description: "Adds independent local search fields to both panels.",
        },
        {
          name: "filterOptions",
          type: "TransferListFilterFunction",
          description:
            "Application-owned filtering for bounded local collections.",
        },
        {
          name: "moveAll",
          type: "boolean",
          defaultValue: "true",
          description: "Shows Move all actions for enabled options.",
        },
        {
          name: "clearSelectionAfterMove",
          type: "boolean",
          defaultValue: "true",
          description:
            "Clears transferred transient selections after movement.",
        },
        {
          name: "renderOption",
          type: "(option, state) => ReactNode",
          description:
            "Customizes visual option content while TransferList owns labels, checkbox state, and accessibility.",
        },
        {
          name: "name",
          type: "string",
          description: "Renders repeated hidden inputs for assigned values.",
        },
      ]}
      relatedComponents={[
        {
          id: "checkbox",
          name: "Checkbox",
          description: "Independent Boolean selection.",
        },
        {
          id: "multi-select",
          name: "MultiSelect",
          description: "Compact small-set multiple selection.",
        },
        {
          id: "autocomplete",
          name: "Autocomplete",
          description: "Searchable single-value selection.",
        },
        {
          id: "select",
          name: "Select",
          description: "Small single-value option sets.",
        },
        {
          id: "grid-basic",
          name: "UniversalDataGrid",
          description: "Large or server-managed resource collections.",
        },
      ]}
      sections={[
        {
...
render(<Example />);`,
            richScope,
            'import { Stack, Text, TransferList } from "@vyrnforge/ui-components";',
          ),
        },
        {
          ...
          children: live(
            "transfer-list-searchable",
            "Independent panel search",
            `<TransferList
...
/>`,
        ...
        },
        {
          ...
          children: live(
            "transfer-list-select-visible",
            "Filter-aware select visible",
            `<TransferList
...
/>`,
        ...
        },
        {
          ...
          children: live(
            "transfer-list-disabled-readonly",
            "Non-editable states",
            `<Stack gap="md">
  <TransferList
    disabled
  ...
  />
            ...
            richScope,
            'import { Stack, TransferList } from "@vyrnforge/ui-components";',
            undefined,
            260,
          ),
        },
...
/>`,
            richScope,
            'import { Badge, Caption, Stack, Text, TransferList } from "@vyrnforge/ui-components";',
          ),
        },
        {
          id: "form-submission",
  ...
  <Button type="submit" variant="primary">Submit assignment</Button>
            ...
            richScope,
            'import { Button, Field, TransferList } from "@vyrnforge/ui-components";',
          ),
        },
        {
  ...
  />
            ...
            baseScope,
            'import { TransferList } from "@vyrnforge/ui-components";',
            "The component stacks panels when its viewport is narrow, and each panel keeps its own scroll container.",
          ),
        },
      ]}
      title="Transfer List"
