...
export function AutocompletePage() {
  ...
  const stateScope = createLiveScope(
    "Autocomplete",
    "Badge",
    "Caption",
    "Field",
  ...
  return (
    <ComponentDemoPage
      ...
      props={[
        {
          name: "options",
          type: "readonly AutocompleteOptionData[]",
          required: true,
          description:
            "Serializable values, labels, optional descriptions, disabled state, and keywords.",
        },
        {
        ...
        {
          name: "inputValue | defaultInputValue",
          type: "string",
          description: "Independent controlled or initial search text.",
        },
        {
          name: "open | defaultOpen",
          type: "boolean",
          defaultValue: "false",
          description: "Independent controlled or initial listbox visibility.",
        },
        {
          name: "onValueChange",
          type: "(value, option) => void",
          description: "Selection callback with selected option data.",
        },
        {
          name: "filterOptions | renderOption",
          type: "function",
          description:
            "Application-owned filtering and option visual rendering.",
        },
        {
          name: "loading | loadingText | noOptionsText",
          type: "boolean | ReactNode",
          description: "Application-provided async-compatible status state.",
        },
        {
          name: "clearable | openOnFocus | autoHighlight",
          type: "boolean",
          description: "Interaction defaults: true, false, and true.",
        },
      ]}
      relatedComponents={[
        {
          ...
          name: "Select",
          description:
            "Small, stable option lists with native select behavior.",
        },
        {
          id: "text-input",
          name: "TextInput",
          description: "Unconstrained text entry.",
        },
        {
          id: "autocomplete",
          name: "SearchInput",
          description:
            "Filtering an existing page or dataset, not selecting a value.",
        },
        {
          id: "popover",
          name: "Popover",
          description: "Underlying shared anchored-content foundation.",
        },
      ]}
      sections={[
        {
...
render(<Example />);`,
            stateScope,
            'import { Autocomplete, Stack, Text } from "@vyrnforge/ui-components";',
          ),
        },
        {
          id: "controlled-input",
          ...
          children: live(
            "autocomplete-controlled-input",
            "Application-owned query",
            `function Example() {
...
/>`,
            basicScope,
            'import { Autocomplete } from "@vyrnforge/ui-components";',
            "Search matches labels and optional keywords while preserving the original option order.",
          ),
        },
        {
          id: "states",
  ...
  <Autocomplete readOnly defaultValue="operator" options={${roleOptions}} />
            ...
            stateScope,
            'import { Autocomplete, Stack } from "@vyrnforge/ui-components";',
          ),
        },
        {
          id: "invalid-state",
  ...
  <ValidationMessage tone="error">Select a workspace role to continue.</ValidationMessage>
            ...
            stateScope,
            'import { Autocomplete, Stack, ValidationMessage } from "@vyrnforge/ui-components";',
          ),
        },
        {
          id: "loading-state",
...
render(<Example />);`,
            basicScope,
            'import { Autocomplete } from "@vyrnforge/ui-components";',
            "The application owns debouncing, requests, cancellation, caching, and errors. This example only simulates loading.",
          ),
        },
        {
          id: "empty-state",
          ...
          children: live(
            "autocomplete-empty",
            "No matching options",
            `<Autocomplete defaultOpen noOptionsText="No matching workspace roles" options={[]} placeholder="Search roles" />`,
            basicScope,
            'import { Autocomplete } from "@vyrnforge/ui-components";',
          ),
        },
...
/>`,
            stateScope,
            'import { Autocomplete, Caption, Stack, Text } from "@vyrnforge/ui-components";',
            "Only the visual content is customized. The listbox roles, state, IDs, labels, and selection behavior remain owned by Autocomplete.",
          ),
        },
        {
          ...
          children: live(
            "autocomplete-field",
            "Field relationship and form value",
            `<Field id="workspace-owner" label="Workspace owner" description="Search by name, team, or keyword." required>
  {(controlProps) => <Autocomplete {...controlProps} name="owner" options={${roleOptions}} placeholder="Select an owner" />}
</Field>`,
            stateScope,
            'import { Autocomplete, Field } from "@vyrnforge/ui-components";',
          ),
        },
      ]}
      title="Autocomplete"
