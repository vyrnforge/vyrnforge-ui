...
export function PopoverPage() {
  return <ComponentDemoPage
    ...
    ]} title="Popover" useWhen={["Showing compact interactive details connected to a trigger.", "The app needs controlled or uncontrolled floating content without menu semantics."]}
  />;
}
...
export function MenuPage() {
  return <ComponentDemoPage
    ...
    ]} title="Menu" useWhen={["Offering a compact list of actions for the current resource.", "A destructive command needs clear danger treatment."]}
  />;
}
...
export function DropdownPage() {
  return <ComponentDemoPage
    ...
    ]} title="Dropdown" useWhen={["Composing small generic floating content without introducing new semantics."]}
  />;
}
...
export function TooltipPage() {
  return <ComponentDemoPage
    ...
    ]} title="Tooltip" useWhen={["Giving a compact explanation for a visible action, especially an icon-only action."]}
  />;
}
...
export function DialogPage() {
  return <ComponentDemoPage
    ...
    ]} title="Dialog" useWhen={["Blocking a focused decision, review, or compact workflow.", "The app needs a dependable modal focus boundary."]}
  />;
}
...
export function DrawerPage() {
  return <ComponentDemoPage
    ...
    ]} title="Drawer" useWhen={["Editing or reviewing a secondary workflow while preserving page context."]}
  />;
}
...
export function ConfirmDialogPage() {
  return <ComponentDemoPage
    ...
    ]} title="Confirm Dialog" useWhen={["A destructive or consequential action needs an explicit final decision."]}
  />;
}
