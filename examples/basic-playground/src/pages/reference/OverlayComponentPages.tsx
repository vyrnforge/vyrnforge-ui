...
export function PopoverPage() {
  return <ComponentDemoPage
    ...
    importCode={'import { Popover } from "@dravyn/ui-components";'}
...
export function MenuPage() {
  return <ComponentDemoPage
    ...
    importCode={'import { Menu } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components"
...
export function DropdownPage() {
  return <ComponentDemoPage
    ...
    importCode={'import { Dropdown } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components"
    ...
    sections={[
      ...
      { id: "controlled-usage", label: "Controlled usage", title: "Controlled usage", children: live("dropdown-controlled", "Controlled dropdown", `function Example() { const [open, setOpen] = React.useState(false); return <Dropdown open={open} onOpenChange={setOpen} trigger={<Button>{open ? "Close" : "Open"} panel</Button>}><Button onClick={() => setOpen(false)}>Done</Button></Dropdown>; } render(<Example />);`, overlayScope, 'import { Button, Dropdown } from "@dravyn/ui-components";') }
    ]}
...
export function TooltipPage() {
  return <ComponentDemoPage
    ...
    importCode={'import { Tooltip } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components"
    ...
    sections={[
      { id: "basic-usage", label: "Hover and focus", title: "Hover and focus", children: live("tooltip-basic", "Helpful description", `<Tooltip content="Refresh the current data"><Button variant="secondary">Refresh</Button></Tooltip>`, overlayScope, 'import { Button, Tooltip } from "@dravyn/ui-components";') },
      { id: "placements", label: "Placement", title: "Placement", children: live("tooltip-placement", "Icon action accessibility", `<Tooltip content="Open filters" placement="right"><IconButton aria-label="Open filters"><Icon name="Filter" /></IconButton></Tooltip>`, overlayScope, 'import { Icon, IconButton, Tooltip } from "@dravyn/ui-components";') },
      { id: "states", label: "Disabled guidance", title: "Disabled guidance", children: live("tooltip-disabled", "Disabled-control guidance", `<Tooltip content="Export is unavailable until at least one row is selected"><span><Button disabled>Export</Button></span></Tooltip>`, overlayScope, 'import { Button, Tooltip } from "@dravyn/ui-components";') }
    ]}
...
export function DialogPage() {
  return <ComponentDemoPage
    ...
    importCode={'import { Dialog } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components"
...
export function DrawerPage() {
  return <ComponentDemoPage
    ...
    importCode={'import { Drawer } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components"
...
export function ConfirmDialogPage() {
  return <ComponentDemoPage
    ...
    importCode={'import { ConfirmDialog } from "@dravyn/ui-components";'} packageName="@dravyn/ui-components"
    ...
    sections={[
      { id: "basic-usage", label: "Normal confirmation", title: "Normal confirmation", children: live("confirm-basic", "Archive confirmation", `function Example() { const [open, setOpen] = React.useState(false); return <><Button onClick={() => setOpen(true)}>Archive report</Button><ConfirmDialog open={open} onOpenChange={setOpen} onConfirm={() => setOpen(false)} title="Archive report" description="The report remains available in the archive." confirmLabel="Archive" /></>; } render(<Example />);`, overlayScope, 'import { Button, ConfirmDialog } from "@dravyn/ui-components";') },
      { id: "destructive", label: "Destructive", title: "Destructive", children: live("confirm-danger", "Destructive confirmation", `function Example() { const [open, setOpen] = React.useState(false); return <><Button onClick={() => setOpen(true)} variant="danger">Delete workspace</Button><ConfirmDialog open={open} onOpenChange={setOpen} onConfirm={() => setOpen(false)} title="Delete workspace" description="All members and records will lose access immediately." confirmLabel="Delete workspace" variant="danger" /></>; } render(<Example />);`, overlayScope, 'import { Button, ConfirmDialog } from "@dravyn/ui-components";') },
      { id: "loading", label: "Loading", title: "Loading", children: live("confirm-loading", "Loading confirmation", `function Example() { const [open, setOpen] = React.useState(false); const [loading, setLoading] = React.useState(false); return <><Button onClick={() => setOpen(true)}>Sync records</Button><ConfirmDialog loading={loading} open={open} onOpenChange={setOpen} onConfirm={() => { setLoading(true); setTimeout(() => { setLoading(false); setOpen(false); }, 900); }} title="Sync records" description="This may take a moment." confirmLabel="Start sync" /></>; } render(<Example />);`, overlayScope, 'import { Button, ConfirmDialog } from "@dravyn/ui-components";') }
    ]}
