    ...
    >
      <DemoSection description="Text, selection, date, and number inputs retain native browser behavior." title="Field composition">
        <DemoBlock
          ...
          preview={<div className="vf-playground-form-grid vf-playground-page-stack"><Field description="Plain text input with helper copy." htmlFor="display-name" label="Display name" required><TextInput id="display-name" defaultValue="Mira Sutanto" /></Field><Field htmlFor="user-search" label="Search" description="Search input keeps native input behavior."><SearchInput id="user-search" placeholder="Search users..." /></Field><Field htmlFor="region" label="Region"><Select id="region" defaultValue="apac" options={[{ label: "APAC", value: "apac" }, { label: "EMEA", value: "emea" }, { label: "AMER", value: "amer" }]} /></Field><div className="vf-playground-grid vf-playground-grid--two"><Field htmlFor="seat-count" label="Seat limit" warning="Integer-only input blocks exponent characters."><NumberInput id="seat-count" mode="integer" min={1} max={500} defaultValue={120} /></Field><Field htmlFor="discount-rate" label="Discount rate"><NumberInput id="discount-rate" mode="decimal" min={0} max={100} step={0.01} defaultValue={12.5} /></Field></div><div className="vf-playground-grid vf-playground-grid--two"><Field htmlFor="start-date" label="Start date" required><DateInput id="start-date" defaultValue="2026-07-10" /></Field><Field htmlFor="review-at" label="Review at"><DateTimeInput id="review-at" defaultValue="2026-07-10T09:30" /></Field></div><Field htmlFor="invalid-field" label="Invalid field" error="Use at least 8 characters."><TextInput id="invalid-field" invalid defaultValue="short" /></Field><Field htmlFor="notes" label="Notes"><Textarea id="notes" defaultValue="Textarea keeps native resizing and validation behavior." /></Field></div>}
