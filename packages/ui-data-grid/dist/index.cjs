...
__export(index_exports, {
  ...
  buildDataGridExportRequest: () => buildDataGridExportRequest,
...
function useDataGridState({
  ...
  const initialState = (0, import_react2.useMemo)(() => createGridState(defaultState), [defaultState]);
...
function DataGridEmptyState({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "udg-empty", colSpan: columnCount, children: message }) });
}
...
function DataGridErrorState({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("td", { className: "udg-error", colSpan: columnCount, role: "alert", children: error }) });
}
...
function DataGridPagination({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "udg-pagination", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "udg-pagination-actions", children: [
...
function DataGridSearch({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { className: "udg-search", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "udg-sr-only", children: placeholder }),
...
function DataGridSkeletonRows({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: Array.from({ length: rowCount }).map((_, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tr", { className: "udg-skeleton-row", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { colSpan: columnCount, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "udg-skeleton-line" }) }) }, index)) });
}

// src/components/DataGridToolbar.tsx
var import_jsx_runtime6 = require("react/jsx-runtime");
function DataGridToolbar({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "udg-toolbar", role: "toolbar", children });
}
...
function UniversalDataGrid({
  ...
  const clientRows = (0, import_react3.useMemo)(() => {
    if (serverMode) {
      return rows;
    }
  ...
  const renderedRows = (0, import_react3.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "section",
    {
      ...
      style,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(DataGridToolbar, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(DataGridSearch, { value: gridState.search, onChange: updateSearch }) }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "udg-table-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("table", { className: "udg-table", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("tr", { children: visibleColumns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            "th",
            {
              style: {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("tbody", { children: [
            ...
            !error && loading && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(DataGridSkeletonRows, { columnCount: visibleColumns.length }),
            !error && !loading && renderedRows.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              DataGridEmptyState,
              {
                columnCount: visibleColumns.length,
            ...
            !error && !loading && renderedRows.map((row, rowIndex) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("tr", { children: visibleColumns.map((column) => {
                const value = getCellValue(row, column);
                return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("td", { children: column.cell ? column.cell({ row, value, rowIndex }) : String(value ?? "") }, column.id);
              }) }, rowId);
            })
          ] })
        ] }) }),
