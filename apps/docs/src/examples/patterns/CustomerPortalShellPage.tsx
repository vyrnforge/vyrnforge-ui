...
export function CustomerPortalShellPage() {
  return (
    <section className="vf-docs-example-panel" data-theme="enterprise">
      <PageHeader
      ...
      />
      <AppShell
        className="vf-docs-example-shell-preview"
        fullHeight={false}
        header={
          <TopNav
            brand={
              <span className="vf-docs-example-top-brand">
                <span className="vf-docs-example-brand__mark">V</span>
                Customer Portal
              </span>
            }
            actions={
        ...
        sidebarWidth={250}
      >
        <div className="vf-docs-example-shell-preview__content">
          <PageHeader
            breadcrumbs={
              <Breadcrumbs
                items={[
