    ...
    <section className="vf-docs-example-panel">
      <div className="vf-docs-example-section-heading">
        <div>
          ...
          <Text tone="muted">
            A compact list pattern for resources, metadata, and actions.
          </Text>
        </div>
        <div className="vf-docs-example-inline-actions">
          <Button leftSlot={<Icon name="Plus" />} variant="primary">
            Register asset
          </Button>
          <Button
      ...
      <div className="vf-docs-example-resource-list">
        {assets.map((asset) => (
          <article className="vf-docs-example-resource-row" key={asset.id}>
            <div>
            ...
            <div className="vf-docs-example-resource-meta">
              <Badge
                variant={
