...
export const userColumns: DataGridColumnDef<UserRecord>[] = [
  {
    ...
    width: 220,
    cell: (_value, row) => (
      <span className="vf-docs-example-demo-user-cell">
  ...
  },
  {
    ...
    width: 110,
    cell: (value) => (
      <span className="vf-docs-example-demo-score">{String(value)}</span>
    ),
  },
  {
    id: "enabled",
    ...
    cell: (value) => (
      <span
        className={
          value
            ? "vf-docs-example-demo-boolean vf-docs-example-demo-boolean-on"
            : "vf-docs-example-demo-boolean vf-docs-example-demo-boolean-off"
        }
      >
...
export function GridNote({ children }: { children: string }) {
  return <p className="vf-docs-example-note">{children}</p>;
}
