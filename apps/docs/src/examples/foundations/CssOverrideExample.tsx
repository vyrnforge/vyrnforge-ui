...
export function CssOverridePage() {
  return (
    <div className="vf-docs-example-page-stack">
      <section className="vf-docs-example-panel vf-docs-example-custom-vf-theme">
        ...
        <Text tone="muted">
          The scoped container changes shared tokens used by primitives and grid
          fallbacks.
        </Text>
      ...
      <section className="vf-docs-example-panel vf-docs-example-grid-only-override">
        <div className="vf-docs-example-card-heading">
          <Heading size="md">Grid-only udg override</Heading>
          <Badge variant="neutral">grid only</Badge>
        </div>
        <Text tone="muted">
          The same component buttons stay unchanged while grid-specific udg
          variables tune only the grid.
        </Text>
        <div className="vf-docs-example-inline-actions">
      ...
      <section className="vf-docs-example-panel vf-docs-example-local-scope-override">
        <div className="vf-docs-example-card-heading">
          <Heading size="md">Local scoped override</Heading>
          <Badge variant="success">scoped</Badge>
        </div>
        <Text tone="muted">
          This panel changes only the subtree it wraps, leaving the rest of the
