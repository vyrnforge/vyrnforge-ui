...
const examples = {
  "theme-modes": {
    title: "Theme Modes",
    description: "Compare shared VyrnForge primitives across scoped light, dark, enterprise, and system themes.",
    sectionTitle: "Interactive theme comparison",
    content: <ThemeModesPage />,
  },
  density: {
    title: "Density",
    description: "Compare compact, standard, and comfortable sizing using the same component contracts.",
    sectionTitle: "Interactive density comparison",
    content: <DensityPage />,
  },
  "css-overrides": {
    title: "CSS Overrides",
    description: "Use VyrnForge tokens and scoped CSS custom properties without introducing framework-specific styling systems.",
    sectionTitle: "Scoped override examples",
    content: <CssOverridePage />,
  },
  "grid-basic": {
    title: "Basic Grid",
    description: "Use UniversalDataGrid for structured data while the consuming application owns business state and workflows.",
    sectionTitle: "Basic grid example",
    content: <BasicGridPage />,
  },
  "grid-columns": {
    title: "Grid Columns",
    description: "Configure reusable column definitions, formatting, and data semantics.",
    sectionTitle: "Column configuration",
    content: <ColumnsPage />,
  },
  "grid-filtering": {
    title: "Grid Filtering",
    description: "Explore local filtering and search behavior without coupling the grid package to application state.",
    sectionTitle: "Filtering example",
    content: <FilteringPage />,
  },
  "grid-grouping": {
    title: "Grid Grouping",
    description: "Group structured data while keeping row ownership in the application.",
  ...
  "grid-selection": {
    ...
    description: "Select rows and surface bulk actions without moving domain mutations into VyrnForge.",
    sectionTitle: "Selection example",
    content: <SelectionPage />,
  },
  "grid-states": {
    title: "Grid States",
    description: "Present empty, loading, and error states consistently around data-management workflows.",
    sectionTitle: "State examples",
    content: <GridStatesPage />,
  },
  "grid-themes": {
    title: "Grid Themes",
    description: "Apply shared theme and density tokens to the specialized data-grid module.",
...
export function UnifiedExamplePage({ exampleId }: { exampleId: UnifiedExampleId }) {
  const example = examples[exampleId];
  return (
    <DocumentationPage
      description={example.description}
      eyebrow={exampleId.startsWith("grid-") ? "Data & Grid" : "Foundations"}
      status={<Badge tone="subtle" variant="success">Live example</Badge>}
      title={example.title}
      sections={[
        {
          id: "example",
        ...
        },
        {
          ...
          content: (
            <Text tone="muted">
              ...
              uses the same VyrnForge packages, tokens, and public contracts as a
